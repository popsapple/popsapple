...
export class MainVisualItemComponent implements OnInit {
  ...
  constructor(){}
  ngOnInit(){
    this.main_visual_item01 = new MainVisualService().getImages('./../../assets/image/visual/main_visual01.jpg', '데스크탑 위에서 작업 중인 사진입니다', "<span display='visible-md visible-lg'>자신의 일을 개선시키려면 </span>불가능을 시도해라", 'Attempt the Inpossible in order to improve your work');
    this.main_visual_item02 = new MainVisualService().getImages('./../../assets/image/visual/main_visual02.jpg', '데스크탑 위에서 작업 중인 사진입니다', "<span display='visible-md visible-lg'>자신의 일을 개선시키려면 </span>불가능을 시도해라",, 'Attempt the Inpossible in order to improve your work');
