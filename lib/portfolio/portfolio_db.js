module.exports = {
  ...
  DELETE_INFO: function(s3,app,mongoose,request,response){
    ...
    global.PORTFOLIO_LIST_DB.DB_SIGMA.findOne(query,function(err,data){
      ...
      console.log("remove_thumnail 00 :: "+JSON.stringify(data));
      console.log("remove_thumnail 01 :: "+remove_thumnail);
      if(remove_thumnail.indexOf('amazon') != -1){
        console.log("remove_thumnail 02 :: "+remove_thumnail.indexOf('amazon'));
