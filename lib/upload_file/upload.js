module.exports.upload_con = function(app,aws,multer,multerS3,fs){
  ...
  app.put('/portfolio_thumnail', function(req, res, next) {
    var remove_thumnail;
    req.body.thumnail_file ? remove_thumnail = req.body.thumnail_file : remove_thumnail = undefined;
  ...
  app.delete('/upload_file', function(req, res, next) {
